...
export function Message({
  ...
  return (
    ...
    >
      <img
        className={
          `peer m-[1px] h-14 w-14 border-separate self-start rounded-full border-b-2 object-cover` +
          " " +
      ...
      <p className="min-w-0 break-words rounded-3xl border-b-2 bg-white px-4 py-2">
        {text}
      </p>
    </div>
  );
