...
export function SideBar() {
  return (
    <div className="flex flex-col justify-between py-5 absolute min-h-screen bg-slate-300 w-64 shadow-lg">
      <nav className="flex flex-col sm:justify-center capitalize">
        {[
          ["Home", "/"],
          ["login", "/login"],
          ["profile", "/profile"],
          ...
          <Link
            to={url}
            key={title}
            className="text-l transition ease-in-out delay-100 hover:shadow hover:translate-x-2 tran pl-8 px-3 py-2 text-slate-700 font-medium hover:bg-amber-100 hover:text-red-500"
          >
            {title}
          </Link>
        ))}
